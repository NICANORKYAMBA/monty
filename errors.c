...
/**
 * handle_error - handles interpreter printing errors
...
/**
 * handle_cerror - handles common interpreter errors
 * @errno: error code to manage
 * @opcode: operation code to manage
 * @line: line on which the error occurred
 *
...
/**
 * handle_uerror - handles interpreter usage errors
 * @errno: error code to manage
 * @line: line on which the error occurred
 *
 * Return: Nothing
...
/**
 * handle_more_uerror - handles interpreter usage errors
 * @errno: error code to manage
 * @line: line on which the error occurred
 *
 * Return: Nothing
